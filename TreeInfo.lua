...
function wordDrag( event )
  ...
  if event.phase == "ended" then
   ...
   function info2 ( event )
    ...
    if wordLeaves.isClicked == true and wordBark.isClicked == true and wordBranches.isClicked == true and wordRoot.isClicked == true and wordTrunk.isClicked == true then
